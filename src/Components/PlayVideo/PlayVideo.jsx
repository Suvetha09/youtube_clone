...
const PlayVideo = () => {
    ...
    const fetchOtherData = async () => {
        ...
        const comment_url = `https://youtube.googleapis.com/youtube/v3/commentThreads?part=snippet%2Cid&&maxResults=10&videoId=${videoId}&key=${API_KEY}`
  ...
  return (
    <div className='play-video'>
        ...
        <div className="play-video-info">
           <p>
            {apiData ? value_converter(apiData.statistics.viewCount) : "0"} Views &bull; { apiData ? moment(apiData.snippet.publishedAt).fromNow() : ""}
            </p>
